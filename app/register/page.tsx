                        ...
                        {isSuccess ? (
                            ...
                            >
                                <div style={{
                                    ...
                                    background: 'rgba(255, 159, 67, 0.1)', border: '2px solid rgba(255, 159, 67, 0.8)',
                                    display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 32px',
                                    boxShadow: '0 0 20px rgba(255, 159, 67, 0.2)'
                                }}>
                                    <div style={{ width: '22px', height: '12px', borderBottom: '3px solid rgba(255, 159, 67, 1)', borderLeft: '3px solid rgba(255, 159, 67, 1)', transform: 'rotate(-45deg)', marginTop: '-4px' }} />
                                </div>
                                <Link href="/" className={styles.loginButton} style={{
                            ...
                            <>
                                ...
                                <form onSubmit={handleRegister} className={styles.form}>
                                    ...
                                    <PremiumButton type="submit" isLoading={isLoading} className={styles.loginButton} style={{ marginTop: '8px' }}>
                                        {t.register.signUp}
                                    </PremiumButton>
                                </form>
